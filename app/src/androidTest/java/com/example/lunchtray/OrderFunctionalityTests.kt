...
import com.example.mysurveybuddy.MainActivity
...
class OrderFunctionalityTests : BaseTest() {
    ...
    /**
     * Test subtotal, tax, and total in [SummaryFragment]
     */
    @Test
    ...
    /**
     * Test that the order is reset after canceling in [SummaryFragment]
     */
    @Test
