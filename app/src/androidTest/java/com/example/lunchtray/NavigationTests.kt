...
class NavigationTests : BaseTest() {
    ...
    /**
     * Test navigation from [AccompanimentMenuFragment] to [SummaryFragment]
     */
    @Test
    ...
    /**
     * Test navigation from [SummaryFragment] to [StartOrderFragment]
     */
    @Test
    fun `navigate_to_start_order_from_checkout`() {
        ...
        val checkoutScenario =
            launchFragmentInContainer<SummaryFragment>(themeResId = R.style.Theme_LunchTray)
